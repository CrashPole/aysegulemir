...
const i18n = {
  tr: {
    ...
    reg_presence:   "&ldquo;Sevgili misafirlerimiz — varlığınız bizim için <em>en anlamlı</em> hediyedir.&rdquo;",
    reg_intro:      "Yine de katkıda bulunmak isterseniz, aşağıdaki hesap bilgilerini kullanabilirsiniz. Yeni hayatımızın ilk anılarına eşlik ettiğiniz için teşekkür ederiz.",
  ...
  en: {
    ...
    reg_presence:   "&ldquo;Dear guests — your presence is the <em>most meaningful</em> gift to us.&rdquo;",
    reg_intro:      "If you'd still like to contribute, the account details below are available. Thank you for being part of the very first memories of our new life.",
